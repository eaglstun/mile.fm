...
function emailValidate( str ) { var at = "@"; var dot = "."; var lat = str.indexOf( at ); var lstr = str.length; var ldot = str.indexOf( dot ); var valid = 1; if ( str.indexOf( at ) == -1 ) { valid = 0 }; if ( str.indexOf( at ) == -1 || str.indexOf( at ) == 0 || str.indexOf( at ) == lstr ) { valid = 0 }; if ( str.indexOf( dot ) == -1 || str.indexOf( dot ) == 0 || str.indexOf( dot ) == lstr ) { valid = 0 }; if ( str.indexOf( at, ( lat + 1 ) ) != -1 ) { valid = 0 }; if ( str.substring( lat - 1, lat ) == dot || str.substring( lat + 1, lat + 2 ) == dot ) { valid = 0 }; if ( str.indexOf( dot, ( lat + 2 ) ) == -1 ) { valid = 0 }; if ( str.indexOf( " " ) != -1 ) { valid = 0 }; return valid };
